...
struct SDCliParams {
    ...
    ArgOptions get_options() {
        ...
        options.string_options = {
            {"-o",
             "--output",
             "path to write result image to. you can use printf-style %d format specifiers for image sequences (default: ./output.png) (eg. output_%03d.png). Single-file video outputs support .avi",
             0,
             &output_path},
            {"",
             "--image",
            ...
            {"",
             "--preview-path",
             "path to write preview image to (default: ./preview.png). Multi-frame previews support .avi",
             0,
             &preview_path},
        };
        ...
        options.manual_options = {
            {"-M",
             "--mode",
             "run mode, one of [img_gen, vid_gen, upscale, metadata], default: img_gen",
             on_mode_arg},
            {"",
             "--preview",
